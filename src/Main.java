...
public class Main {
    ...
    System.out.println("---- Génération données question 7 ----\n");
        for (double p = 0; p <= 1; p+=0.1) {
            for (double q = 0; q <= 1; q+=0.1) {
                ...
                for (int i = 0; i < nItt; i++) {
                    ...
                    moy += Algorithm.algorithm1(graph, false);  // changer algorithm1 par algortihm2 pour tester notre deuxième algorithm
                }
      ...
      /* Graph graph = GraphBuilder.buildQuestion5Graph(100, 0.1, 0.9);
        ...
        Algorithm.algorithm2(GraphBuilder.G, true);  //Graphe du projet pour etre sur qu'il donne le meme k qu'a la question 1*/
